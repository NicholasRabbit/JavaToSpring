package com.springframe.transaction.trans02.dao;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.jdbc.core.JdbcTemplate;
import org.springframework.stereotype.Repository;

import com.springframe.transaction.trans02.myException.NotEnoughBookException;
...
public class BookDao implements BookDaoInterface{
	...
	public void updateBalance(Integer price,Integer pid) {
				...
				System.out.println("balance==>"+balance);    //这里输出的数据不一定准，因为有可能会回滚
